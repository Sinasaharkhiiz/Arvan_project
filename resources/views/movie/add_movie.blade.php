    ...
    <main>
      ...
      <div class="row g-5" style="display: flex;justify-content: center; background-color: rgba(22, 24, 22, 0.5)">
        <div class="col-md-7 col-lg-8">
          ...
          <form class="needs-validation" novalidate method="post" action="add_movie" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
              <div class="col-sm-12">
                <label for="Title" class="form-label" >عنوان</label>
                <input type="text" class="form-control" dir="ltr" id="Title" name="Title" placeholder="" value="" required>
              ...
              <div class="col-sm-6" >
                ...
                <input dir="ltr" type="text" class="form-control" id="Genre" name="Genre" placeholder="Action, Adventure,..." value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-3">
                ...
                <input type="text" class="form-control" id="Year" name="Year" placeholder="2024" value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-3">
                ...
                <input type="text" class="form-control" id="Duration" name="Duration" placeholder="60" value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                ...
                <input type="text" dir="ltr" class="form-control" id="Description" name="Description" placeholder="خلاصه کوتاهی از فیلم" value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-sm-6" >
                ...
                <input dir="ltr" type="text" class="form-control" id="Poster" name="Poster" placeholder="https://m.media-amazon....." value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-6">
                ...
                <input type="text" dir="ltr" class="form-control" id="Cast" name="Cast" placeholder="Actor1,actor2,..." value="" required>
                <div class="invalid-feedback">
                  Valid description is required.
                </div>
              </div>
