            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="width: 100px">
                  <br>
                  <li class="nav-item">
                    <a class="navbar-brand active" aria-current="page" href="/"><img src="logo.png" alt="unilink" style="width: 100px;"></a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="movies">فیلم </a>
                  </li>
                  <li class="nav-item">
                    @if (Auth::check())
                      @if (Auth::user()->role=='super_admin')
                      <a class="nav-link" aria-current="page" href="add_movie">افزودن‌فیلم</a>
                      @endif
                    @endif
                  </li>
                </li>
...
<div class="container" style="margin-top: 50px">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center">
      ...
      <span class="mb-3 mb-md-0 text-light">&copy; 2024 | Chat Movie  </span>
    </div>
